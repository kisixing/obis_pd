...
import { pharacyinput, hemorrhageselect, bloodinput, whetherbleedingselect } from "./business";
...
export const editors = {...inputs,...selects,...times,...dates,...buttons,...mixs,...cascader,...treeselect,pharacyinput, hemorrhageselect, bloodinput, whetherbleedingselect};
